...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4D43AB4;
	constexpr ptrdiff_t dwForceAttack = 0x3175088;
	constexpr ptrdiff_t dwForceAttack2 = 0x3175094;
	constexpr ptrdiff_t dwForceBackward = 0x31750DC;
	constexpr ptrdiff_t dwForceForward = 0x31750B8;
	constexpr ptrdiff_t dwForceJump = 0x51ED750;
	constexpr ptrdiff_t dwForceLeft = 0x31750D0;
	constexpr ptrdiff_t dwForceRight = 0x3175058;
	constexpr ptrdiff_t dwGameDir = 0x6285F8;
	constexpr ptrdiff_t dwGameRulesProxy = 0x5260A2C;
	constexpr ptrdiff_t dwGetAllClasses = 0xD55F1C;
	constexpr ptrdiff_t dwGlobalVars = 0x589AD0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x528B880;
	constexpr ptrdiff_t dwInput = 0x5195060;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x8F9AF4;
	constexpr ptrdiff_t dwLocalPlayer = 0xD2FB84;
	constexpr ptrdiff_t dwMouseEnable = 0xD35728;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xD356F8;
	constexpr ptrdiff_t dwPlayerResource = 0x31733FC;
	constexpr ptrdiff_t dwRadarBase = 0x5178824;
	constexpr ptrdiff_t dwSensitivity = 0xD355C4;
	constexpr ptrdiff_t dwSensitivityPtr = 0xD35598;
	constexpr ptrdiff_t dwSetClanTag = 0x89E00;
	constexpr ptrdiff_t dwViewMatrix = 0x4D353F4;
	constexpr ptrdiff_t dwWeaponTable = 0x5195B24;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
	constexpr ptrdiff_t dwYawPtr = 0xD35388;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD3A5D0;
	constexpr ptrdiff_t dwbSendPackets = 0xD3C5A;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
	constexpr ptrdiff_t m_pStudioHdr = 0x294C;
	constexpr ptrdiff_t m_yawClassPtr = 0xD35388;
	constexpr ptrdiff_t m_pitchClassPtr = 0x5178AC8;
	...
	constexpr ptrdiff_t set_abs_angles = 0x1CF130;
	constexpr ptrdiff_t set_abs_origin = 0x1CEF70;
	...
	constexpr ptrdiff_t find_hud_element = 0x2DEEC270;
